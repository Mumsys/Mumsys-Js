"use strict";class Mumsys{static getVersion(){return'3.0.0';}
constructor(){}
static checkJsonRpcResponce(response){if(!(response instanceof Object)){var message='Invalid json rpc resopnse';throw new Error(message);}}}
